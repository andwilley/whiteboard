    ...
    <div className="row">
        <div className="col-6">
            <FlexInputContainer
                ...
                name="pilot"
                value={pilot}
                onInputChange={onPilotNameChange}
                errorConfig={{
            ...
            <FlexInputContainer
                ...
                name="pilotCodes"
                value={pilotCodes}
                onInputChange={onPilotCodeChange}
            ...
            {/* <FlexInputContainer
                ...
                name="pilotSymbols"
                value={pilotSymbols}
                onInputChange={onPilotSymbolChange}
                errorConfig={{show: [], update: [], errorLoc: errorLocs.FLIGHT, errorLocId: flightId}}
        ...
        <div className="col-6">
            ...
            {/* <FlexInputContainer
                ...
                name="wsoSymbols"
                value={wsoSymbols}
                onInputChange={onWSOSymbolChange}
                errorConfig={{show: [], update: [], errorLoc: errorLocs.FLIGHT, errorLocId: flightId}}
