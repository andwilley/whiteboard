...
const CrewList = ({ aircrewList, addUpdateAircrewFormValues, onAircrewClick, onXClick, onEditClick, onInputChange, onAddUpdateAircrewSubmit, onAddAircrewFormButtonClick, onDelAircrewFormButtonClick }) => (
    <div>
        <ul>
        ...
        <AddUpdateAircrewForm addUpdateAircrewFormValues={addUpdateAircrewFormValues} onInputChange={event => onInputChange(event)} onSubmit={input => onAddUpdateAircrewSubmit(input)} />
    </div>
);
