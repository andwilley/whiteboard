...
const getSchedErrors = (state: IState, aircrewRefList: IAircrew[]): IErrors[] => {
    /**
     * @param
     * @param
...
const getOnChangeWithNameMatch = (
    ...
    return (e) => {
        ...
        if (ownProps.addNameIdTo && errors) {
            errors.forEach(error => {
                dispatch(actions.addError(error));
            };
            dispatch(actions.updateSchedConflictErrors(errors.map(error => error.id)));
        }
        ownProps.onChange(e);
    };
};
